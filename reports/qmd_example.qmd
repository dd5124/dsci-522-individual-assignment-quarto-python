...
![](../results/horse_pops_plot.png){width=70% #fig-horse-pops}

@fig-horse-pops: Horse populations for all provinces in Canada from 1906 - 1972.
...
@tbl-horse Standard deviation of historical (1906-1972) horse populations for each Canadian province.
...
Additionally, note that in @tbl-horse we consider the sample standard deviation of the number of horses during the same time span as @fig-horse-pops.

![](../results/horse_pops_plot_largest_sd.png){width=70% #fig-horse-pops-sd}

@fig-horse-pops-sd: Horse populations for the province with the largest standard deviation
